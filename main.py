...
with tab1:
    ...
    calc_cols[1].metric(f"Valor Mensal ", format_currency(val_por_mensal), delta="{num_mensal}x)
    calc_cols[2].metric(f"Valor Semestral", format_currency(val_por_semestral), delta="{num_semestral}x)
